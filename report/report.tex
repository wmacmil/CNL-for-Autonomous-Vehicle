...
over our whole experimental apparatus and assumptions in designing the data set. 
...
was easily done with basic functional programming techniques utilizing lists and
tuples, although in the future it would certainly be better to use a Lens
library interface. For instance, one can quickly filter the most common
...
grammar. We sketch a strategy for this integration. Once can presumably define a
threshold to choose the most frequent nouns and adjectives, and verbs too.
