...
% (theWomanWithTheDog \wedge F\; (theBridge
% \wedge \wedge G\; FINISHED))))$. This visible as an AST represented as a Haskell datatype \term{Phi} :
...
% instruction ``turn left''). We note that the condition should be ``is_left'',
